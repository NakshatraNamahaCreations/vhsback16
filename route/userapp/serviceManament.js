...
router.get("/getserviceNameManagement", ServiceManagemntController.getserviceNameManagement);

router.get("/getserviceDirection", ServiceManagemntController.getserviceDirection);
...
router.post("/updateenabledisble/:id", ServiceManagemntController.activeStatusenble);
router.get("/getservicedetailswithlazyloading",ServiceManagemntController.getServicedetailswithlazyloading);
